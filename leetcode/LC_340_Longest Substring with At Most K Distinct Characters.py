...
sol = Solution()
s, k = 'eceabd', 2
assert sol.lengthOfLongestSubstringKDistinct(s, k) == 3
# print(sol.subtringCountsWithKDistinctChar(s, k))

s, k = 'abcde', 2
assert sol.lengthOfLongestSubstringKDistinct(s, k) == 2

s, k = 'bbbbb', 2
assert sol.lengthOfLongestSubstringKDistinct(s, k) == 5
